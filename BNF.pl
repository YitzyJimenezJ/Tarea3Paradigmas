...
ejecutar_pruebas :-
    ...
    test_es_en('soy azul?'),
    nl,
    test_es_en('Tu eres azul?'),
    nl,
    test_es_en('El gato es rojo?'),
    nl,
    test_es_en('Eres feliz?'),
    nl,
    writeln('--- PREGUNTAS YES/NO NEGATIVAS ---'),
    test_es_en('no soy viejo?'),
    nl,
    test_es_en('Tu no eres azul?'),
    nl,
    test_es_en('Como estas?'),
    nl,
    test_es_en('Donde esta el gato?'),
    nl,
    ...
    nl,
    test_en_es('Am I blue?'),
    nl,
    test_en_es('Are you happy?'),
    nl,
    test_en_es('Are you not blue?'),
    nl,
    test_en_es('How are you?'),
    nl,
    test_en_es('What is your name?'),
    nl,
