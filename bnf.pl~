% ======================================================================
% BNF.pl - Interfaz de Usuario MEJORADA con Continuidad
% Sistema Experto de Traducción - TransLog
% ======================================================================
...
ejecutar_pruebas :-
    ...
    nl,
    test_es_en('Yo soy Jose'),
    nl,
    test_es_en('Voy al parque'),
    nl,
